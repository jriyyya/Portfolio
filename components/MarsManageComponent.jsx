...
const MarsFoodComponent = () => {
    ...
    return(
        ...
        <img src="/tablet.png" alt="tablet" className="tablet absolute w-[68%] right-12 z-20" data-value="1"/>
        <img src="/tablet-down.png" alt="tablet-down" className="absolute bottom-0 z-10"/>
      </div>
)
}
